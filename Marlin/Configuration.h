...
#define STRING_CONFIG_H_AUTHOR "Indmenity83" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender-3 Sprite (4.2.2)"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -31.5, -40.0, -2.07 }
